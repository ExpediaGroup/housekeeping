 ...
 */
package com.hotels.housekeeping.spring;
...
import com.hotels.housekeeping.spring.conf.Housekeeping;
import com.hotels.housekeeping.spring.converter.StringToDurationConverter;

@Configuration
@EnableAutoConfiguration
@EnableConfigurationProperties(Housekeeping.class)
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = { "com.hotels.housekeeping.spring" })
