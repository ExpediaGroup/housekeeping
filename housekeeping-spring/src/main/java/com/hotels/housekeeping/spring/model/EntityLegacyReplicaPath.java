 ...
 */
package com.hotels.housekeeping.spring.model;
...
@MappedSuperclass
public abstract class EntityLegacyReplicaPath implements ILegacyReplicaPath {
  ...
  public EntityLegacyReplicaPath(String path) {
    this.path = path;
    this.eventId = "";
    this.pathEventId = "";
  }

  public EntityLegacyReplicaPath(String eventId, String pathEventId, String path) {
