 ...
 */
package com.hotels.housekeeping.tool.vacuum.validation.constraintvalidators;
...
import com.hotels.housekeeping.tool.vacuum.validation.constraints.TunnelRoute;
...
public class TunnelRouteValidator implements ConstraintValidator<TunnelRoute, CharSequence> {
   ...
   */
  private static final Pattern LOCAL_PATTERN = Pattern.compile(ATOM + "+(\\." + ATOM + "+)*", CASE_INSENSITIVE);
